...
void Otto::sing(int songName)
{
  ...
  case S_stoomboot:
    _tone(note_G4, 500, 300);  // zie
    _tone(note_C5, 500, 300);  // ginds
    _tone(note_C5, 500, 300);  // komt
    _tone(note_E5, 500, 300);  // de
    _tone(note_D5, 500, 300);  // stoom
    _tone(note_D5, 500, 300);  // boot
    _tone(note_F5, 500, 300);  // uit
    _tone(note_B5, 500, 300);  // Span
    _tone(note_B5, 500, 300);  // je
    _tone(note_D5, 500, 300);  // weer
    _tone(note_C5, 1000, 300); // aan
    _tone(note_G4, 500, 300);  // hij
    _tone(note_C5, 500, 300);  // brengt
    _tone(note_C5, 500, 300);  // ons
    _tone(note_E5, 500, 300);  // sint
    _tone(note_D5, 250, 100);  // ni
    _tone(note_D5, 250, 100);  // co
    _tone(note_D5, 500, 300);  // laas
    _tone(note_F5, 500, 300);  // ik
    _tone(note_B5, 500, 300);  // zie
    _tone(note_B5, 500, 300);  // hem
    _tone(note_D5, 500, 300);  // al
    _tone(note_C5, 1000, 300); // staan
    delay(500);
    _tone(note_G6, 500, 300);  // hoe
    _tone(note_D6, 500, 300);  // hup
    _tone(note_D6, 500, 300);  // pelt
    _tone(note_G6, 500, 300);  // zijn
    _tone(note_E6, 500, 300);  // paard
    _tone(note_E6, 500, 300);  // je
    _tone(note_G6, 500, 300);  // het
    _tone(note_F6, 500, 300);  // dek
    _tone(note_F6, 500, 300);  // op
    _tone(note_E6, 500, 300);  // en
    _tone(note_D6, 1000, 300); // neer
    _tone(note_G6, 500, 300);  // hoe
    _tone(note_C6, 500, 300);  // waai
    _tone(note_C6, 250, 150);  // e
    _tone(note_D6, 250, 150);  // en
    _tone(note_E6, 250, 150);  // de
    _tone(note_F6, 250, 150);  // e
    _tone(note_G6, 500, 300);  // wim
    _tone(note_E6, 500, 300);  // pels
    _tone(note_C6, 500, 300);  // al
    _tone(note_F6, 500, 300);  // heen
    _tone(note_D6, 500, 300);  // en
    _tone(note_B6, 500, 300);  // al
    _tone(note_C6, 1000, 300); // weer
    delay(1000);
    break;
  }
}
